...
- [Verify Watermark Removal](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/verify-watermark-removal.mdc) - Measuring a watermark-removal claim before repeating it: mark, meaning, facts, verbatim runs, and length.
